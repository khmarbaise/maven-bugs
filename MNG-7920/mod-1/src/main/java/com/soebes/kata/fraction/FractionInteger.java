 ...
 */
public class FractionInteger implements Comparable<FractionInteger> {
  ...
  public FractionInteger plus(FractionInteger add) {
    if (this.denominator == add.denominator) {
      ...
      int num = add.numerator * this.denominator + this.numerator * add.denominator;
      int den = add.denominator * this.denominator;
  ...
  public FractionInteger subtract(FractionInteger subtrahend) {
    if (this.denominator == subtrahend.denominator) {
      int num = this.numerator - subtrahend.numerator;
      int den = this.denominator;
      return new FractionInteger(num, den);
    } else {
      int num = this.numerator * subtrahend.denominator - this.denominator * subtrahend.numerator;
      int den = subtrahend.denominator * this.denominator;
      return new FractionInteger(num, den);
    }
  }
